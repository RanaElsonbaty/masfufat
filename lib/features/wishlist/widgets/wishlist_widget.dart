        ...
        Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) => ProductDetails(
                ...
                slug: wishlistModel?.product!.slug,
                product: wishlistModel!.product!,
              ),
            ));
      },
      child: Padding(
          ...
          child: IntrinsicHeight(
            child: Row(
              ...
              children: [
                ...
                wishlistModel?.product!.unitPrice != null &&
                        wishlistModel!.product!.discount! > 0
                    ? Positioned(
                        ...
                        child: Container(
                            ...
                            child: Text(
                                wishlistModel?.product!.unitPrice != null &&
                                        wishlistModel?.product!.discount !=
                                            null &&
                                        wishlistModel?.product!.discountType !=
                                            null
                                    ? PriceConverter.percentageCalculation(
                                        context,
                                        wishlistModel?.product!.unitPrice,
                                        wishlistModel!.product!.discount,
                                        wishlistModel?.product!.discountType)
                                    : '',
                ...
                Expanded(
                    child: Column(
                      ...
                      Row(children: [
                        Expanded(
                            child: Text(wishlistModel?.product?.name ?? '',
                                maxLines: 2,
                   ...
                   Padding(
                                ...
                                child: Text(
                                  '(${getTranslated('tax', context)} :${PriceConverter.convertPrice(context, (wishlistModel!.product!.tax??0/100*wishlistModel!.product!.unitPrice!))})',
                                  style: GoogleFonts.tajawal(
