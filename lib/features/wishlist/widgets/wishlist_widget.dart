        ...
        child: IntrinsicHeight(
          child: Row(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.start, children: [
            ...
            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Row(children: [
                Expanded(child: Text(wishlistModel?.product?.name ?? '',maxLines: 1,overflow: TextOverflow.ellipsis,
              ...
              Row(children: [
                wishlistModel!.product!.discount != null && wishlistModel!.product!.discount!>0?
                CustomDirectionalityWidget(
                  child: Text(wishlistModel!.product!.unitPrice != null?
                  PriceConverter.convertPrice(context, wishlistModel!.product!.unitPrice):'',
                    style: titilliumSemiBold.copyWith(color: ColorResources.getReviewRattingColor(context),
