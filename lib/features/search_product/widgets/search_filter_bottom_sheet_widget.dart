...
class SearchFilterBottomSheetState extends State<SearchFilterBottomSheet> {
  ...
  double hi = MediaQuery.of(Get.context!).size.width;
  @override
                ...
                return Column(
                  ...
                  children: [
                    ...
                    FilterItemWidget(
                        ...
                        index: 2),
                    FilterItemWidget(
                        title: getTranslated('Low_to_high_quantity', context),
                        index: 3),
                    FilterItemWidget(
                        title: getTranslated('High_to_low_quantity', context),
                        index: 4),
                    FilterItemWidget(
                        title: getTranslated('More_preferable', context),
                        index: 5),
                    FilterItemWidget(
                        title: getTranslated('Highest_ratings', context),
                        index: 6),
                    FilterItemWidget(
                        title: getTranslated('Special_offers', context),
                        index: 7),
                    const SizedBox(
                      height: 15,
                    ),
                    Text(getTranslated('Sync_status', context) ?? '',
                        style: titilliumSemiBold.copyWith(
                            fontSize: Dimensions.fontSizeLarge)),
                    SyncFilterItemWidget(
                        title: getTranslated('Sync_status', context), index: 0),
                    SyncFilterItemWidget(
                        title: getTranslated('Asynchronous_products', context),
                        index: 1),
                    SyncFilterItemWidget(
                        title: getTranslated('Synchronized_products', context),
                        index: 2),
                    Padding(
                      padding:
