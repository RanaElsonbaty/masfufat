      ...
      builder: (context, homeCategoryProductController, child) {
        ...
        ListView.builder(
            ...
            itemBuilder: (ctx, index) {
              return homeCategoryProductController.homeCategoryProductList[index].products!=null&& homeCategoryProductController.homeCategoryProductList[index].products!.isNotEmpty?HomeCategoryProductItemWidget(homeCategoryProduct: homeCategoryProductController.homeCategoryProductList[index],
              index: index, isHomePage: isHomePage):const SizedBox.shrink();
            })
            : const SizedBox();
      },
    );
