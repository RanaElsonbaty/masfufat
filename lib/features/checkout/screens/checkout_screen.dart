...
class CheckoutScreenState extends State<CheckoutScreen> {
  ...
  void initPayment() async {
    ...
    await Provider.of<PaymentController>(context, listen: false)
        .getAmount(((widget.totalOrderAmount)));
    //  await  Provider.of<PaymentController>(Get.context!,listen: false).getApiKey(Get.context!);
    await Provider.of<PaymentController>(Get.context!, listen: false)
        .initiate(Get.context!);
    await Provider.of<PaymentController>(Get.context!, listen: false)
        .getPaymentMethod(Get.context!, 'order');
    ...
    Provider.of<PaymentController>(Get.context!, listen: false)
        .getType('order');
    Provider.of<PaymentController>(Get.context!, listen: false).getOrderId('');
            ...
            return Consumer<CouponController>(
              ...
              return Consumer<CartController>(
                ...
                return Consumer<ProfileController>(
                  ...
                  return orderProvider.selectedDigitalPaymentMethodId != 1
                      ? orderProvider.isLoading
                          ...
                          : Padding(
                              ...
                              child: Consumer<PaymentController>(
                                builder: (context, paymentProvider, child) =>
                                    CustomButton(
                                  onTap: orderProvider.addressIndex == null
                                      ? null
                                      : () async {
                                          if (orderProvider.addressIndex ==
                                            ...
                                            if (!orderProvider
                                              ...
                                              String orderNote = orderProvider
                                                  ...
                                                  .trim();
                                              String couponCode = couponProvider
                                                              .discount !=
                                                          null &&
                                              ...
                                              String addressId = orderProvider
                                                          .addressIndex !=
                                                      null
                                                  ? locationProvider
                                                      .addressList![
                                              ...
                                              if (orderProvider
                                                          .selectedDigitalPaymentMethodId ==
                                                      2 &&
                                                  !widget.onlyDigital) {
                ...
                child: ListView(
                    ...
                    children: [
                      ...
                      Consumer<PaymentController>(
                          builder: (context, paymentProvider, child) =>
                              paymentProvider.isLoading == false
                                  ? CheckOutPaymentSection(
                                      amount: widget.totalOrderAmount,
                                    )
                                ...
                                Container(
                                  ...
                                  child: CustomTextFieldWidget(
                                      hintText: getTranslated(
                                          'Enter_any_comments_here', context),
