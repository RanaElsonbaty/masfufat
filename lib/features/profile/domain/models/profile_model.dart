...
class ProfileModel {
  ...
  factory ProfileModel.fromJson(Map<String, dynamic> json) {
    return ProfileModel(
      ...
      subscriptionStart: json["subscription_start"]!=null?json["subscription_start"]:"",
      subscriptionEnd: json["subscription_end"]!=null?json["subscription_end"]:"",
...
class StoreInformations {
  ...
  factory StoreInformations.fromJson(Map<String, dynamic> json) => StoreInformations(
    ...
    name: json["name"],
    vendorAccountNumber:json['vendor_account_number']!=null?json['vendor_account_number']:"",
    phone: json["phone"],
    ...
    expiryDateCommercialRegister: json['release_date_commercial_register']!=null? json['release_date_commercial_register']:"",
    expiryDateTaxNo:json['expiry_date_commercial_register'] !=null?json['expiry_date_commercial_register'] :"",
    releaseDateCommercialRegister: json['release_date_tax_no']!=null?json['release_date_tax_no']:"",
    releaseDateTaxNo: json['expiry_date_tax_no']!=null? json['expiry_date_tax_no']:"",
    releaseDateIdNumber:json['release_date_id_number']!=null?json['release_date_id_number']:"",
    expiryDateIdNumber:json['expiry_date_id_number']!=null?json['expiry_date_id_number']:"",
    email: json["email"],
    password: json["password"]!=null?json["password"]:'',
    delegateName: json["delegate_name"]!=null?json["delegate_name"]:'',
    ...
    employer :json['employer']!=null?json['employer']:"",
    occupation :json['occupation']!=null?json['occupation']:"",
    siteUrl:json['site_url']!=null?json['site_url'] :"",
    address: json["address"]!=null?json["address"]:'',
    plan: json["plan"],
    remember: json["remember"]!=null? json["remember"].toString():'',
    image: json["image"],
    IdNumber:json['id_number']!=null?json['id_number']:"",
    identityType:json['identity_type']!=null?json['identity_type']:"",
    commercialRegistrationImg: json["commercial_registration_img"]!=null?json["commercial_registration_img"]:'',
