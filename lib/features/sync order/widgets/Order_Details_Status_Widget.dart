...
class SyncOrderDetailsStatusWidget extends StatelessWidget {
  const SyncOrderDetailsStatusWidget({super.key});
              ...
              Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                Column(mainAxisAlignment: MainAxisAlignment.center,crossAxisAlignment: CrossAxisAlignment.center, children: [
                  RichText(text: TextSpan(
                    ...
                    TextSpan(text: orderProvider.syncOrderDetails?.id.toString(),
                  ...
                  RichText(text: TextSpan(
                    ...
                    TextSpan(text: ' ${getTranslated('${orderProvider.syncOrderDetails?.orderStatus}', context)}',
                        style: textBold.copyWith(fontSize: Dimensions.fontSizeLarge,
                            color: orderProvider.syncOrderDetails?.orderStatus == 'delivered'?  ColorResources.getGreen(context) :
                            orderProvider.syncOrderDetails?.orderStatus == 'pending'? Theme.of(context).primaryColor :
                            orderProvider.syncOrderDetails?.orderStatus == 'confirmed'? ColorResources.getGreen(context)
                                :orderProvider.syncOrderDetails?.orderStatus == 'processing'? ColorResources.getPurple(context) :
                            (orderProvider.syncOrderDetails?.orderStatus == 'canceled' || orderProvider.syncOrderDetails?.orderStatus == "failed")? ColorResources.getRed(context) :
