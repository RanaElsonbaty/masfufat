...
class SyncCancelAndSupportWidget extends StatelessWidget {
  final SyncOrderDetailsModel? orderModel;
  final bool fromNotification;
  const SyncCancelAndSupportWidget({super.key, this.orderModel, this.fromNotification = false});
