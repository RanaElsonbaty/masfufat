            ...
            child: SizedBox(
              ...
              child: ListView(
                ...
                children:  [
                  ...
                  const   SizedBox(width: Dimensions.paddingSizeSmall),
                  SyncOrderTypeButtomWidget(text: 'Preparing', index: 6, pagingController: _pagingController),
                  const SizedBox(width: Dimensions.paddingSizeSmall),
                  SyncOrderTypeButtomWidget(text: 'ready', index: 5, pagingController: _pagingController),
                  const  SizedBox(width: Dimensions.paddingSizeSmall),
