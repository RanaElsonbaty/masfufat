            ...
            child: SizedBox(
              ...
              child: ListView(
                ...
                children:  [
                  ...
                  SyncOrderTypeButtomWidget(text: 'pending', index: 1, pagingController: _pagingController),
                  const  SizedBox(width: Dimensions.paddingSizeSmall),
                  SyncOrderTypeButtomWidget(text: 'confirmed', index: 2, pagingController: _pagingController),
                  const  SizedBox(width: Dimensions.paddingSizeSmall),
                  SyncOrderTypeButtomWidget(text: 'processing', index: 3, pagingController: _pagingController),
                  const   SizedBox(width: Dimensions.paddingSizeSmall),
                  SyncOrderTypeButtomWidget(text: 'out_for_delivery', index: 4, pagingController: _pagingController),
                  const   SizedBox(width: Dimensions.paddingSizeSmall),
                  SyncOrderTypeButtomWidget(text: 'delivered', index: 5, pagingController: _pagingController),
                  const SizedBox(width: Dimensions.paddingSizeSmall),
                  SyncOrderTypeButtomWidget(text: 'failed', index: 6, pagingController: _pagingController),
                  const  SizedBox(width: Dimensions.paddingSizeSmall),
                  SyncOrderTypeButtomWidget(text: 'returned', index: 7, pagingController: _pagingController),
                  const SizedBox(width: Dimensions.paddingSizeSmall),
                  SyncOrderTypeButtomWidget(text: 'CANCELED', index: 8, pagingController: _pagingController),
                ],
              ),
            ),
          ),
