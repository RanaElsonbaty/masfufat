  ...
  Future<ApiResponse> getList({int? offset}) async {
    try {
      List<OnboardingModel> onBoardingList = [
        ...
        OnboardingModel(Images.onBoarding4,
          getTranslated('on_boarding_title_four', Get.context!),
          getTranslated('on_boarding_description_four', Get.context!)),
      ];
