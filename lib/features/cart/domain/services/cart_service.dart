...
class CartService implements CartServiceInterface{
  ...
  @override
  Future addToCartListData(CartModelBody cart,  List<int>? variationIndexes, int buyNow, int? shippingMethodExist, int? shippingMethodId) async {
    return await cartRepositoryInterface.addToCartListData(cart, variationIndexes, buyNow, shippingMethodExist, shippingMethodId);
  }
