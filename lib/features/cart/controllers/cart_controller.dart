...
class CartController extends ChangeNotifier {
  ...
  Future<ApiResponse> addToCartAPI(CartModelBody cart, BuildContext context,  List<int>? variationIndexes, {int buyNow = 0, int? shippingMethodExist, int? shippingMethodId}) async {
