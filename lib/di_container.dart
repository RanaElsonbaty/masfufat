...
import 'package:flutter_sixvalley_ecommerce/features/Store%20settings/domain/repositories/store_setting_repository.dart';
import 'package:flutter_sixvalley_ecommerce/features/Store%20settings/domain/services/store_setting_service.dart';
...
import 'package:flutter_sixvalley_ecommerce/features/my%20shop/domain/services/my_shop_service.dart';
...
import 'package:flutter_sixvalley_ecommerce/features/sync%20order/domain/repositories/sync_order_repository.dart';
...
import 'package:flutter_sixvalley_ecommerce/features/sync%20order/domain/services/sync_order_service.dart';
...
Future<void> init() async {
  ...
  sl.registerLazySingleton(() => StoreSettingRepository(dioClient: sl()));
  ...
  sl.registerLazySingleton(() => MyShopRepository(dioClient: sl()));
  ...
  sl.registerLazySingleton(() => SyncOrderRepository(dioClient: sl()));
  ...
  sl.registerFactory(() => PaymentController(paymentServiceInterface: sl()));
  ...
  sl.registerFactory(() => StoreSettingController(storeSettingInterface: sl()));
  sl.registerFactory(() => MyShopController(myShopServiceInterface: sl()));
  ...
  sl.registerFactory(() => SyncOrderController(syncOrderServiceInterface: sl()));
  ...
  StoreSettingInterface storeSettingInterface = StoreSettingRepository(dioClient: sl());
  sl.registerLazySingleton(() => storeSettingInterface);
  StoreSettingServiceInterface storeSettingServiceInterface = StoreSettingService(storeSettingInterface: sl());
  sl.registerLazySingleton(() => storeSettingServiceInterface);

  SyncOrderRepositoryInterface syncOrderRepositoryInterface = SyncOrderRepository(dioClient: sl());
  sl.registerLazySingleton(() => syncOrderRepositoryInterface);
  SyncOrderServiceInterface syncOrderServiceInterface = SyncOrderService(syncOrderRepositoryInterface: sl());
  sl.registerLazySingleton(() => syncOrderServiceInterface);

  PaymentRepositoryInterface paymentRepositoryInterface = PaymentRepository(dioClient: sl());
  sl.registerLazySingleton(() => paymentRepositoryInterface);
  PaymentServiceInterface paymentServiceInterface = PaymentsService(paymentRepositoryInterface: sl());
  sl.registerLazySingleton(() => paymentServiceInterface);
  ...
  MyShopRepositoryInterface myShopRepositoryInterface = MyShopRepository(dioClient: sl());
  sl.registerLazySingleton(() => myShopRepositoryInterface);
  MyShopServiceInterface myShopServiceInterface = MyShopService(myShopServiceInterface:  sl());
  sl.registerLazySingleton(() => myShopServiceInterface);
  ...
  sl.registerLazySingleton(() => MyShopService(myShopServiceInterface: sl()));
  ...
  sl.registerLazySingleton(() => SyncOrderService(syncOrderRepositoryInterface : sl()));
  sl.registerLazySingleton(() => CompareService(compareRepositoryInterface : sl()));
  sl.registerLazySingleton(() => StoreSettingService(storeSettingInterface : sl()));
