...
class AppConstants {
  ...
  static const String baseUrl = 'https://platform.masfufat.com';
  ...
  static const String topProductUri = '/api/v1/products/products-lazy?page=';
  ...
  static const String sellerList = '/api/v1/seller/top';
